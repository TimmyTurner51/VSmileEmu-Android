...
// Renamed to avoid conflict with Android NDK's ucontext.h register definitions
enum cpu_reg {
  CPU_REG_SP = 0,
  CPU_REG_R1 = 1,
  CPU_REG_R2 = 2,
...
// Shorter aliases for convenience (no conflict in file scope)
#define REG_SP CPU_REG_SP
#define REG_R1 CPU_REG_R1
#define REG_R2 CPU_REG_R2
#define REG_R3 CPU_REG_R3
#define REG_R4 CPU_REG_R4
#define REG_BP CPU_REG_BP
#define REG_SR CPU_REG_SR
#define REG_PC CPU_REG_PC
